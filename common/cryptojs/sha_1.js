...
var key = CryptoJS.enc.Utf8.parse("8da0e0de08691b91");
var iv = CryptoJS.enc.Utf8.parse('4823512749539481');

function Encrypt(word) {
    var srcs1 = CryptoJS.enc.Utf8.parse(word);
    var encrypted = CryptoJS.AES.encrypt(srcs1, key, {iv: iv, mode: CryptoJS.mode.CBC, padding: CryptoJS.pad.Pkcs7});
...
const CryptoJSsss = CryptoJS || function (g, l) {
...
function Screct(value, screct) {
    return CryptoJSsss.HmacSHA1(value, screct).toString();
}
