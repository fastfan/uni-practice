	...
	>
		<slot name="label">
			<view
				...
				:class="[!label && !required ? 'no-label' : '', labelClass]"
 ...
 *  @property {String } 	labelClass 		自定义修改label的class
 *
 */
...
export default {
	...
	methods: {
		...
		// 处理 label 位置
		_labelPosition() {
			if (this.form) return this.labelPosition ? this.labelPosition : this.form.labelPosition || 'left'
			return 'left'
		},
