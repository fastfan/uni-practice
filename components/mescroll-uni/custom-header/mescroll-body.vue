<template>
	<!-- 移除 miniheight -->
	<!-- <view class="mescroll-body mescroll-render-touch content" 
		...
		:prop="wxsProp"> -->
	<view class="mescroll-body mescroll-render-touch content"
		:style="{'height':'100%', 'padding-top': padTop, 'padding-bottom': padBottom}"
		:class="{'mescorll-sticky': sticky}" @touchstart="wxsBiz.touchstartEvent" @touchmove="wxsBiz.touchmoveEvent"
		@touchend="wxsBiz.touchendEvent" @touchcancel="wxsBiz.touchendEvent" :change:prop="wxsBiz.propObserver"
		:prop="wxsProp">
		...
		<view class="mescroll-body-content mescroll-wxs-content content-box"
			...
			<view v-if="mescroll.optDown.use" class="mescroll-downwarp"
				...
				<view class="downwarp-content">
					<image class="downwarp-slogan"
						src="https://51plat.oss-cn-beijing.aliyuncs.com/51Integral/static/images/index/down_refresh.png"
						mode="widthFix" />
			...
			<!-- 列表内容 -->
			<scroll-view class="scroll-warp" style="height: 100%;" :scroll-y="true" @scroll="onScroll">
				<slot></slot>
			</scroll-view>
